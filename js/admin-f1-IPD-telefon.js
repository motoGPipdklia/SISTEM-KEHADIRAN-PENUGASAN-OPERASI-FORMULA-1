...
function binaRekodImportPenggunaCsv(barisCsv) {
  ...
  const alias = {
    ...
    IPD: ["IPD", "IPD_ASAL", "DISTRIK", "DISTRICT_POLICE"],
...
function muatTurunTemplatPengguna() {
  const kandungan = [
    "NO_BADAN,PANGKAT,NAMA,IPD,NO_TELEFON,PERANAN,BAHAGIAN,DAERAH,KATA_LALUAN,AKTIF",
    "197898,L/KPL,NORHISHAM BIN CHE MAT,IPD KLIA,0193151615,PETUGAS,BKDNKA,SEPANG,Skpo@A7m2#1,YA",
    "199898,SJN,AHMAD BIN ALI,IPD SEPANG,0123456789,PENYELIA,CAWANGAN KHAS,SEPANG,Skpo@B9n4#2,YA",
    "PUSATF1,INSP,PUSAT KAWALAN FORMULA 1,IPK SELANGOR,0123456789,PUSAT_KAWALAN,IPK,SELANGOR,Skpo@F1PK2026#1,YA"
  ].join("\r\n");
